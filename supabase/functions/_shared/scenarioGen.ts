...
export const THEME_LABELS: Record<ScenarioTheme, Record<'ko' | 'en', string>> = {
  meditation: {
...
- stop.title must be a natural ${localeLabel} place name a traveler would recognize for that koreanName (common English/Japanese/Chinese name, not a letter-by-letter romanization unless that is the usual name).
